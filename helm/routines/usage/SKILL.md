---
name: usage
description: How you work with AI, from your own Claude Code and Codex transcripts. Now runs from inkprint (npx github:jarrheyd/inkprint); this routine forwards to it. Use for "usage", "how do I work", "open the usage page".
---
...
```bash
HELM_VAULT="/path/to/Your Name OS" npx github:jarrheyd/inkprint
```
