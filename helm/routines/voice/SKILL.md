...
Exit 2 means it's out of your range in that channel: rewrite from your last sends in that thread and check again. The hook on draft and send tools is installed by `npx github:jarrheyd/inkprint`.
